...
def main():
	...
	db.execute("CREATE TABLE review (isbn VARCHAR NOT NULL, uid VARCHAR NOT NULL, bid VARCHAR NOT NULL, rating VARCHAR NOT NULL, review VARCHAR NOT NULL)")
	...
	for isbn,title,author,year in reader:
		if year == "year":
			...
			print(f"Addedd book {title} by {author}, isbn{isbn}")
